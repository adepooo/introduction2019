...
#define PASSWORD    "243543649"//改为你的WiFi密码Wi-Fi密码
#define DEVICEID    "573456859" //OneNet上的设备ID
String apiKey = "hUFB9YXT=zOlaXdQzusWdUd10=4=";//与你的设备绑定的APIKey
...
//3,传感器值的设置 
float sensor_tem, sensor_hum, sensor_lux,pir;                    //传感器温度、湿度、光照   
